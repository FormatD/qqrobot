...
[assembly: WebActivator.PreApplicationStartMethod(typeof(WebQQ2.DLL.App_Start.SQLCEEntityFramework), "Start")]

namespace WebQQ2.DLL.App_Start {
    ...
    public abstract class SqlCeInitializer<T> : IDatabaseInitializer<T> where T : QQDbContext {
    ...
    public class CreateCeDatabaseIfNotExists<TContext> : SqlCeInitializer<TContext> where TContext : QQDbContext {
    ...
    /// To seed the database, create a derived class and override the Seed method.
    /// </summary>
    public class DropCreateCeDatabaseIfModelChanges<TContext> : SqlCeInitializer<TContext> where TContext : QQDbContext {
        #region Strategy implementation
    ...
    /// </summary>
    /// <typeparam name="TContext">The type of the context.</typeparam>
    public class DropCreateCeDatabaseAlways<TContext> : SqlCeInitializer<TContext> where TContext : QQDbContext {
        #region Strategy implementation
